class Univariate():
    ...
    def Univariate(dataset,quan):
        descrip=pd.DataFrame(index=["Mean","Median","Mode","Q1:25%","Q2:50%","Q3:75%","99%","Q4:100%",
                                    "IQR","1.5rule","Lesser","Greater","Min","Max","Kurtosis","Skew","Variance","STD",
                                    "Deviation"],columns=quan)
        for columnName in quan:
            ...
            descrip[columnName]["Kurtosis"]=dataset[columnName].kurtosis()
            descrip[columnName]["Skew"]=dataset[columnName].skew()
            descrip[columnName]["Variance"]=dataset[columnName].var()
            descrip[columnName]["STD Deviation"]=dataset[columnName].std()
        return descrip   
